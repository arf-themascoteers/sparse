...
from algorithms.zhangfc.zhangfc_net import ZhangFCNet
import numpy as np
import math


class AlgorithmZhangFC(Algorithm):
    ...
    def get_selected_indices(self):
        ...
        zhangnet = ZhangFCNet(self.splits.train_x.shape[1], class_size, last_layer_input).to(device)
