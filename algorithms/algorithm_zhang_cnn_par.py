...
from algorithms.zhang.zhang_net_cnn import ZhangNetCNNPar
from torch.utils.data import TensorDataset, DataLoader
import train_test_evaluator


class Algorithm_zhang_cnn_par(Algorithm_zhang):
    def __init__(self, target_size:int, splits:DataSplits, tag, reporter, verbose):
        ...
        self.zhangnet = ZhangNetCNNPar(self.splits.train_x.shape[1], self.class_size, self.last_layer_input).to(self.device)
